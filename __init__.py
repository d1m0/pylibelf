...
define(lelf.elf_begin, [ c_int, Elf_Cmd, ElfP ], ElfP, nonNullDec)
...
define(lelf.elf_errmsg, [ c_int ], c_char_p, nonNullDec)
...
define(lelf.elf_getdata, [ Elf_ScnP, Elf_DataP ], Elf_DataP, nonNullDec)
...
define(lelf.elf_strptr, [ ElfP, c_size_t, c_size_t ], c_char_p, nonNullDec)
